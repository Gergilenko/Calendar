        ...
        <div class="col-md-4">
            ...
            <form action="/calendar/save" method="post">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="name" value="<?= $isNew ? '' : $dayoff->name ?>" autofocus required>
                </div>
                <div class="form-group">
                ...
                <?php endif; ?>
                <button id="saveday" type="submit" class="btn btn-success">Сохранить</button>
